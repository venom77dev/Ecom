                                            ...
                                            <x-core::table.body.row>
                                                ...
                                                <x-core::table.body.cell>
                                                    <a href="{{ route('payment.show', $order->payment->id) }}" target="_blank">
                                                        {{ \App\PaymentSlug\CustomPaymentSlug::getPgNameLabel($order->payment) }}
                                            ...
                                            <x-core::table :striped="false" :hover="false" class="w-100">
                                                <x-core::table.body>
                                                    ...
                                                    <x-core::table.body.row>
                                                        ...
                                                        <x-core::table.body.cell>
                                                            {{ $history->description . ' ' . trans('plugins/ecommerce::order.from') . ' ' .  \App\PaymentSlug\CustomPaymentSlug::getPgNameLabel($order->payment) }} }} }}
                                                        </x-core::table.body.cell>
                                                    </x-core::table.body.row>
                                                    <x-core::table.body.row>
                                                        <x-core::table.body.cell>
                                            ...
                                            <x-core::table :striped="false" :hover="false" class="w-100">
                                                ...
                                                <x-core::table.body.row>
                                                    ...
                                                    <x-core::table.body.cell>{!! trans('plugins/ecommerce::order.mark_payment_as_confirmed', [
                                                                'method' => \App\PaymentSlug\CustomPaymentSlug::getPgNameLabel($order->payment),
                                                            ]) !!}
                                                    </x-core::table.body.cell>
                                                </x-core::table.body.row>
                                                <x-core::table.body.row>
