    ...
    CanResetPasswordContract
{
    ...
    public function checkMobileNumberExistOrNot($mobile)
    {
        try {
            return $this->where('phone', $mobile)->exists();
    ...
    public function checkUserExist( $phone): bool
    {
        try {
            $result = $this->where(function ($q) use ($phone) {
